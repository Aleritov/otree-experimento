...
class Constants(BaseConstants):
    ...
    num_rounds = 3 # Actual num_rounds is specified in session config, by the length of the list 'timeseries_filename'!
...
class Player(BasePlayer):
    cash = models.FloatField(initial=100000)
    shares = models.FloatField(initial=10)
